...
_BASE_COA: list[_COAEntry] = [
    ...
    _COAEntry("2103", "เจ้าหนี้เช่าซื้อ", "2", "liability", "CR",
              parent_code="2100", name_en="Hire Purchase Payable"),
    _COAEntry("2104", "ดอกเบี้ยรอตัดบัญชี", "2", "liability", "DR",
              parent_code="2100", name_en="Deferred Interest (Hire Purchase)"),
